...
function Titulo() {
  ...
  return (
    <nav style={{ backgroundColor: '#111215', borderColor: '#111215' }} className="border-blue-300 bg-blue-200 dark:bg-blue-900 dark:border-blue-100">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
        <img src="./logo.png" className="h-12" alt="Editora Logo" />
        <img src="./logoescrito.png" className="h-12" alt="Editora Logo" />
        </Link>
