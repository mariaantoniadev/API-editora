...
export default function Home() {
  ...
  const [geral, setGeral] = useState<geralTipo>({
    clientes: 0, livros: 0, avaliacoes: 0, avaliacoes_dia: 0, precoMedio: 0
  })
    ...
    <div className="container">
      ...
      <div className="w-2/3 flex justify-between mx-auto mb-5">
        ...
        <div className="border-red-600 border rounded p-6">
          <span className="bg-red-100 text-red-800 text-xl text-center font-bold mx-auto block px-2.5 py-5 rounded dark:bg-red-900 dark:text-red-300">{geral.livros}</span>
      ...
      <h2 className="text-2xl font-bold mt-4">Gráfico: Nº de Estrelas dadas pelos clientes para os livros cadastrados (em %)</h2>
